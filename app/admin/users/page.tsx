          ...
          <div className="flex justify-center mt-6 space-x-2">
            ...
            {[...Array(totalPages)].map((_, index) => (
              <Button
                ...
                className={`px-3 py-1 ${currentPage === index + 1 ? 'bg-gray-500 text-white' : 'bg-gray-200 text-black hover:bg-gray-700'} rounded`}
              >
                {index + 1}
              </Button>
            ))}
...
{showAddUserModal && (
 <div className="w-700">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <input type="text" placeholder="First Name" name="fname" className="p-2 w-full border rounded" required />
    <input type="text" placeholder="Last Name" name="lname" className="p-2 w-full border rounded" required />

    <input type="email" placeholder="Email" name="email" className="p-2 w-full border rounded" required />
    <input type="text" placeholder="Username" name="username" className="p-2 w-full border rounded" required />

    <input type="password" placeholder="Password" name="password" className="p-2 w-full border rounded" required />
    <input type="text" placeholder="Phone" name="phone" className="p-2 w-full border rounded" />

    <input type="text" placeholder="Street" name="street" className="p-2 w-full border rounded" />
    <input type="text" placeholder="City" name="city" className="p-2 w-full border rounded" />

    <input type="text" placeholder="State" name="state" className="p-2 w-full border rounded" />
    <input type="text" placeholder="Zip Code" name="zip" className="p-2 w-full border rounded" />

    <input type="text" placeholder="Country" name="country" className="p-2 w-full border rounded" />
    {/* Role Select */}
    <select name="role" className="p-2 w-full border rounded" required>
  ...
  <Modal onClose={() => setShowEditUserModal(false)}>
    <div className="p-4">
      ...
      <form onSubmit={handleUpdateUser}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <input type="text" name="fname" defaultValue={userToEdit.fname} className="p-2 w-full border rounded" required />
          ...
          <input type="text" name="state" defaultValue={userToEdit.state} className="p-2 w-full border rounded" />
          <input type="text" name="zip" defaultValue={userToEdit.zip} className="p-2 w-full border rounded" />
          <input type="text" name="country" defaultValue={userToEdit.country} className="p-2 w-full border rounded" />
          <select name="role" defaultValue={userToEdit.role} className="p-2 w-full border rounded" required>
            <option value="">Select Role</option>
            <option value="ADMIN">Admin</option>
            <option value="USER">User</option>
            <option value="STAFF">Staff</option>
